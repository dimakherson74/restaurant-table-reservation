...
urlpatterns = [
    ...
    path("users/craete", UsersCreateView.as_view(), name="user-create", ),
    path("user/<int:pk>/detail", UsersDetailView.as_view(), name="user-detail", ),
    ...
    path("my-reservations/<int:pk>/", my_reservations, name="my-reservations", ),
